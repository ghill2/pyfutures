...
class TestContinuousBar:
    ...
    def test_to_dict(self):
        # Act
        values = ContinuousBar.to_dict(self.price1)
    ...
    def test_from_dict_returns_expected_price(self):
        # Arrange, Act
        result = ContinuousBar.from_dict(ContinuousBar.to_dict(self.price1))
    ...
    def test_continuous_price_serialize_roundtrip(self):
        ...
        # Act
        serialized = ArrowSerializer.serialize(self.price1, data_cls=ContinuousBar)
        deserialized = ArrowSerializer.deserialize(data_cls=ContinuousBar, batch=serialized)
