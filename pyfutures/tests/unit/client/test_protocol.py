...
async def test_data_received_single(event_loop):
    ...
    call_args_list = [call((b"63", b"1", b"-10", b"DU7606863", b"EquityWithLoanValue", b"868521.81", b"GBP"))]
...
async def test_data_received_multiple(event_loop):
    ...
    call_args = [
        ...
        call((b"63", b"1", b"-10", b"DU7606863", b"AvailableFunds", b"862955.49", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"BuyingPower", b"3451821.94", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"EquityWithLoanValue", b"868533.39", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"ExcessLiquidity", b"864071.07", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"FullAvailableFunds", b"862955.49", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"FullExcessLiquidity", b"864071.07", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"FullInitMarginReq", b"5577.91", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"FullMaintMarginReq", b"4462.33", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"GrossPositionValue", b"0.00", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"InitMarginReq", b"5577.91", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"LookAheadAvailableFunds", b"862955.49", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"LookAheadExcessLiquidity", b"864071.07", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"LookAheadInitMarginReq", b"5577.91", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"LookAheadMaintMarginReq", b"4462.33", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"MaintMarginReq", b"4462.33", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"NetLiquidation", b"869687.77", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"PreviousDayEquityWithLoanValue", b"385217.48", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"SMA", b"387055.34", b"GBP")),
        call((b"63", b"1", b"-10", b"DU7606863", b"TotalCashValue", b"868992.32", b"GBP")),
        call((b"64", b"1", b"-10")),
    ]
